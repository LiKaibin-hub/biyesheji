...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="cccccc">  
  ...
  <tr>
    ...
    <td width="60" align="center"><a class="btn btn-info btn-small" href='sushefenpei_add.jsp?id=<%=map.get("id")%>'>添加宿舍分配</a> <a class="btn btn-info btn-small" href="xinshengxinxi_detail.jsp?id=<%=map.get("id")%>">详细</a> </td>
  </tr>
  	<%
  }
   %>

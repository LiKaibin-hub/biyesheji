...
%>
<form action="jspmyxglyfwxthsg9790W1B4?ac=login&amp;a=a" method="post" name="f11" id="f11" style="display: inline">
    <table width='100%' height='302' border='0' cellpadding='0' cellspacing='0' bgcolor='#FFFFFF' class='newsline'>
        ...
        <tr>
            ...
            <td height='28'>密码:</td>
            <td height='28' colspan='2'>
                <input name='pwd1' type='password' id='pwd1' placeholder='请输入密码'
                       style='width:160px; height:40px; border:solid 1px #000000; color:#666666'/>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td width='653'>
                <a href="javascript:loadimage();">
                    <img alt="看不清请点我！" name="randImage" id="randImage" src="image.jsp"
        ...
        <tr>
            ...
            <td height='38' colspan='2'>
                <input type='submit' name='Submit' value='登陆' onclick='return checklog();'/>
...
<table width='100%' height='300' border='0' align='center' cellpadding='0' cellspacing='0' bgcolor='#FFFFFF'>
    ...
    <tr>
        <td height='28' align='left' style='padding-left:20px; font-size:20px;'>
            您的权限：<%=request.getSession().getAttribute("cx")%>
        </td>
    </tr>
    <tr>

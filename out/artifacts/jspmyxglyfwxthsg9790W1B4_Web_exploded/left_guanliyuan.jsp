...
<dl class="custom">
			...
			<dd><a href="xueshengxinxi_add.jsp" target="hsgmain">新生信息添加</a></dd>
<dd><a href="xinshengxinxi_list.jsp" target="hsgmain">新生信息查询</a></dd>

		</dl>
<dl class="custom">
			<dt onClick="changeImage()">班级管理<img src="images/left/select_xl01.png"></dt>
			<dd><a href="banjixinxi_add.jsp" target="hsgmain">班级添加</a></dd>
<dd><a href="banjixinxi_list.jsp" target="hsgmain">班级查询</a></dd>

		</dl>
<dl class="custom">
			<dt onClick="changeImage()">专业管理<img src="images/left/select_xl01.png"></dt>
...
<dl class="custom">
			<dt onClick="changeImage()">宿舍管理<img src="images/left/select_xl01.png"></dt>

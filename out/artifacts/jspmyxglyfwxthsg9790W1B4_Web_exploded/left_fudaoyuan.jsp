...
<dl class="custom">
			...
			<dd><a href="fudaoyuanxinxi_updt2.jsp" target="hsgmain">修改个人资料</a></dd>
		...
		int aa=0;
		aa=quanxianfenpei.indexOf("校园信息管理；");
		if(aa>=0)
		{
		%>
		
		<dl class="custom">
			<dt onClick="changeImage()">校园信息管理<img src="images/left/select_xl01.png"></dt>
			<dd><a href="xinwentongzhi_add.jsp?lb=入校须知" target="hsgmain">入校须知添加</a></dd>
<dd><a href="xinwentongzhi_list.jsp?lb=入校须知" target="hsgmain">入校须知查询</a></dd>
<dd><a href="xinwentongzhi_add.jsp?lb=校园新闻" target="hsgmain">校园新闻添加</a></dd>
<dd><a href="xinwentongzhi_list.jsp?lb=校园新闻" target="hsgmain">校园新闻查询</a></dd>
<dd><a href="xinwentongzhi_add.jsp?lb=校园公告" target="hsgmain">校园公告添加</a></dd>
<dd><a href="xinwentongzhi_list.jsp?lb=校园公告" target="hsgmain">校园公告查询</a></dd>

		</dl>
		<%
		}
		aa=quanxianfenpei.indexOf("系统简介设置；");
		if(aa>=0)
		{
		%>
<dl class="custom">
...
<dd><a href="dx.jsp?lb=联系方式" target="hsgmain">联系方式设置</a></dd>
		...
		aa=quanxianfenpei.indexOf("物资管理；");
		if(aa>=0)
		{
		%>
		...
		<dl class="custom">
			...
			<dt onClick="changeImage()">物资管理<img src="images/left/select_xl01.png"></dt>
			
			


			
			<dd><a href="rukuxinxi_add.jsp" target="hsgmain">物资入库</a></dd>
<dd><a href="rukuxinxi_list2.jsp" target="hsgmain">物资入库查询</a></dd>
			<dd><a href="chukuxinxi_add.jsp" target="hsgmain">物资出库</a></dd>
<dd><a href="chukuxinxi_list2.jsp" target="hsgmain">物资出库查询</a></dd>
		...
		aa=quanxianfenpei.indexOf("新生管理；");
		if(aa>=0)
		{
		%>
		
		<dl class="custom">
			<dt onClick="changeImage()">新生管理<img src="images/left/select_xl01.png"></dt>
...
<dl class="custom">
			<dt onClick="changeImage()">宿舍分配管理<img src="images/left/select_xl01.png"></dt>
			<dd><a href="xinshengxinxi_sushefenpei.jsp" target="hsgmain">宿舍分配</a></dd>
<dd><a href="sushefenpei_list2.jsp" target="hsgmain">宿舍分配查询</a></dd>

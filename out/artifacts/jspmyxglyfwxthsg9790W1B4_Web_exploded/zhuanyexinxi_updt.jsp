...
new CommDAO().update(request,response,"zhuanyexinxi",ext,true,false,""); 
HashMap mmm = new CommDAO().getmap(id,"zhuanyexinxi"); 

%>
  <form  action="zhuanyexinxi_updt.jsp?f=f&id=<%=mmm.get("id")%>"  method="post" name="form1"  onsubmit="return checkform();">
  修改专业信息:
  <br><br>

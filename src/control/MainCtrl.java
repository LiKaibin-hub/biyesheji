	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(ac.equals("login"))
		{
			...
			if(!pagerandom.equals(random)&&request.getParameter("a")!=null)
			{
				...
				if(utype.equals("辅导员")){sql1 = "select * from fudaoyuanxinxi where gonghao='"+username+"' and mima='"+password+"' ";}
if(utype.equals("学生")){sql1 = "select * from xinshengxinxi where xuehao='"+username+"' and mima='"+password+"'";}
		...
		//按照学号查找
		if(ac.equals("findByXuehao")){
			String xuehao = request.getParameter("xuehao");
			String sql = "select * from xinshengxinxi where xuehao="+xuehao;
			List<HashMap> select = dao.select(sql);
			if(select.size()==1){

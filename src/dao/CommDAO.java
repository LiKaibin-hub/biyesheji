		...
		public Connection getConn()
		{
		        ...
		        { 
		        	if(conn==null||conn.isClosed()){
						...
						// conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/newstudents","root","root");
						 
						 Class.forName("com.mysql.jdbc.Driver");
			        	 conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/newstudents?characterEncoding=utf8","root","root");
			        	 
			        	// Class.forName("net.sourceforge.jtds.jdbc.Driver");
			        	// conn = DriverManager.getConnection("jdbc:jtds:sqlserver://127.0.0.1:1433;databaseName=jspmyxglyfwxthsg9790W1B4","sa","sa123456");
		            }}
		        catch(Exception e)
		        {
		            e.printStackTrace();

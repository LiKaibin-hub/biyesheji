    ...
    <div class="container">
      ...
      <nav id="nav-menu-container">
        <ul class='nav-menu'>
		  ...
		  <%--<li class='menu-has-children'><a href='lyb.jsp'>在线留言</a>
            <ul><li><a href='lyb.jsp'>在线留言</a></li> <li><a href='lyblist.jsp'>查看留言</a></li> </ul>--%>
          </li> <li class='menu-has-children'><a href='news.jsp?lb=ruxiaoxuzhi'>新闻信息</a>
            <ul><li><a href='news.jsp?lb=ruxiaoxuzhi'>入校须知</a></li> <li><a href='news.jsp?lb=xiaoyuanxinwen'>校园新闻</a></li> <li><a href='news.jsp?lb=xiaoyuangonggao'>校园公告</a></li> </ul>
         <%-- </li> <li class='menu-has-children'><a href='dx_detail.jsp?lb=guanyuwomen'>系统概要</a>
            <ul><li><a href='dx_detail.jsp?lb=guanyuwomen'>关于我们</a></li> <li><a href='dx_detail.jsp?lb=lianxifangshi'>联系方式</a></li> <li><a href='dx_detail.jsp?lb=xitongjianjie'>系统简介</a></li> </ul>--%>
          </li> <li class='menu-has-children'><a href='xiaoyuanfengguanglisttp.jsp'>校园风光</a>
